...
const navigate=useNavigate();
  ...
  if (type) {
    ...
    <li key={el}>
              <a class="dropdown-item" onClick={()=>changeCategoryOptionHandler(el)}>
                {el}
              </a>
            </li>);
  }
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div class="dropdown-center ms-1">
          ...
          <ul class="dropdown-menu" onChange={changeSelectOptionHandler}>
            <li>
              <a class="dropdown-item" onClick={()=>changeSelectOptionHandler("Academic")}>
                Academic
              </a>
            </li>
            <li>
              <a class="dropdown-item"  onClick={()=>changeSelectOptionHandler("Non Academic")}>
                Non-Academic
              </a>
            </li>
        ...
        <textarea placeholder="Grievance" className="form-control w-75 mb-2" onChange={handleGrievanceChange} style={{borderRadius:"50px", boxShadow:"2px 2px 2px 2px #4D00AF", color:"#4D00AF"}} ></textarea>
